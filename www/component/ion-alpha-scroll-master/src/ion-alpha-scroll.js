'use strict';
angular
    .module ('ion-alpha-scroll', ['ionic'])
    .directive ('ionAlphaScroll', function ($ionicScrollDelegate, $location, $timeout, $document) {
    return {
        require : '?ngModel',
        restrict: 'AE',
        replace : true,
        compile : function (tElement, tAttrs, tTransclude) {
            ...
            var template = angular.element ([
                ...
                '<div data-collection-repeat="(letter, items) in sorted_items" class="ion_alpha_list">',
