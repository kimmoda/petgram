...
angular
    .module ('ui.calendar')
    .service ('calendarHelper', function calendarHelper ($filter, gettextCatalog, moment) {
    var self = this;
    ...
    this.convertDate          = function (month, day, year) {
        var date = month + '/' + month + '/' + year;
        var time = '0:0:0';
