(function (window, angular, ionic, undefined) {
    ...
    function PhotoService ($ionicActionSheet, AppConfig, PhotogramShare, $jrCrop, $rootScope, $ionicModal, $cordovaCamera, gettextCatalog, $q, Notify) {
