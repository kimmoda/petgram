  ...
  function jrCropFactory($ionicModal, $rootScope, $q) {
    ...
    function crop() {
      ...
      if (this.options.resizeWidth || this.options.resizeHight) {
        ...
        console.log("before: canvas width = " + canvas.width + " height = " + canvas.height + " length = " + canvas.toDataURL()
          .length);
        resizeCanvas(canvas, canvas.width, canvas.height, resizeWidth, resizeHight);
        console.log("after: canvas width = " + canvas.width + " height = " + canvas.height + " length = " + canvas.toDataURL()
          .length);
      }
