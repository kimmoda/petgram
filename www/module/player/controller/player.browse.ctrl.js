...
angular
    ...
    .controller ('PlayerBrowseCtrl', function ($window, $ionicPlatform, $rootScope, $scope, $ionicScrollDelegate, AudioSvc, $ionicModal) {
        $scope.files = [];

        $ionicModal.fromTemplateUrl ('module/player/view/player.media.html', {
            scope: $scope
        }).then (function (modal) {
            $scope.modal = modal;
        });
