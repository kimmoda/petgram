...
angular
    .module('module.user')
    .factory('User', function ($q, $filter, $rootScope, $timeout, $location, Parse, $cordovaGeolocation, $cordovaDevice, $window, $facebook, $cordovaFacebook, $state, ParseConfig, Notify) {
